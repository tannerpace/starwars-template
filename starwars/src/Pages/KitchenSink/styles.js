  ...
  return (
    <Container>
      ...
      <Box marginBottom={5}>
        ...
        <Typography variant="h4">Contained Rounded</Typography>
        <Box className={classes.buttons}>
          <ButtonRounded variant="contained">Default</ButtonRounded>
          <ButtonRounded variant="contained" disabled>
            Default
          </ButtonRounded>
          <ButtonRounded variant="contained" color="primary">
            Primary
          </ButtonRounded>
          <ButtonRounded variant="contained" color="primary" disabled>
            Primary
          </ButtonRounded>
          <ButtonRounded variant="contained" color="secondary">
            Secondary
          </ButtonRounded>
          <ButtonRounded variant="contained" color="secondary" disabled>
            Secondary
          </ButtonRounded>
          <ButtonRounded
            variant="contained"
        ...
        <Typography variant="h4">Outlined Rounded</Typography>
        <Box className={classes.buttons}>
          <ButtonRounded variant="outlined" size="small">
            Default
          </ButtonRounded>
          <ButtonRounded variant="outlined" disabled>
            Default
          </ButtonRounded>
          <ButtonRounded variant="outlined" color="primary">
            Primary
          </ButtonRounded>
          <ButtonRounded variant="outlined" color="primary" disabled>
            Primary
          </ButtonRounded>
          <ButtonRounded variant="outlined" color="secondary">
            Secondary
          </ButtonRounded>
          <ButtonRounded variant="outlined" color="secondary" disabled>
            Secondary
          </ButtonRounded>
          <ButtonRounded
            variant="outlined"
        ...
        <Box>
          ...
          <Box>
            ...
            <AppBar position="static" color="default" style={{ width: 225 }}>
              <Tabs
              ...
              >
                <Tab
                  label="Item One"
                  icon={<Badge badgeContent={99} color="primary" />}
                />
                <Tab
                  label="Item Two"
                  icon={<Badge badgeContent={99} color="primary" invisible />}
                />
                <Tab
                  label="Item Three"
                  icon={<Badge badgeContent={99} color="primary" />}
        ...
        <Box>
          ...
          <Grid container>
            <Grid item sm={6}>
              ...
              <Checkbox defaultChecked color="secondary" disabled />
              <FormControlLabel
